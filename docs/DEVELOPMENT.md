...
`pre-commit` checks Rust formatting, Rust types across all features, Isen
formatting, whole-tree Isen diagnostics with optional ML enabled, and generated
reference freshness. It never rewrites files.
